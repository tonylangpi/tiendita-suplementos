...
export default function Tabla({ datos }) {
  ...
  const columns = useMemo(
    //configuracion de las columnas que vienen en la tabla
    () => [
      {
  ...
  //configuracion del envio de datos post
  ...
  return (
    <>
      ...
      if (
       ...
       let res = await axios.delete('http://localhost:3000/api/seguridad/empresa/'+ row.index); 
       if (res.status === 204) {
        router.refresh();
      }
    }}>
